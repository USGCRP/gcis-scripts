...
grab-doi-info.pl -- Quick script to grab info for Kristin & Tess

=head1 DESCRIPTION

Given an input of DOIs (one per line), outputs a CSV containing:

DOI, Title, Author First, Authors All, Date Created, Date Publisehd Print, Date Published Online, Web Link

DOI                   - the given DOI
Author First          - First Author et al
Authors All           - Comma separated list of the authors
Date Created          - Created Date
Date Published Print  - Print publish date
Date Published Online - Web publish date
Web Link              - the web URI


'crossref.org' is used to obtain biblio information


=head1 SYNOPSIS

./grab-doi-info.pl [OPTIONS] < list-of-dois.txt
